    ...
    if (workflowData) {
        try {
            ...
            if (workflowData.checkpointName === 'sd_xl_base_1.0.safetensors') {
                ...
                parameters.innerHTML += `<br><strong>${i18next.t('helpS73')}:</strong> ${workflowData.sampler}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS74')}:</strong> ${workflowData.scheduler}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS75')}:</strong> ${workflowData.cfg}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS77')}:</strong> ${workflowData.steps}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS78')}:</strong> ${workflowData.stepsRefiner}`;
                ...
                if (workflowData.lora == 'None') {
                    ...
                    parameters.innerHTML += `<br><strong>${i18next.t('helpS712')}:</strong> ${workflowData.loraStrength}`;
                }
                prompts.innerHTML = `<strong>${i18next.t('positivePrompt')}:</strong> ${workflowData.promptP}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS73')}:</strong> ${workflowData.sampler}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS74')}:</strong> ${workflowData.scheduler}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS76')}:</strong> ${workflowData.guidance}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS77')}:</strong> ${workflowData.steps}`;
                parameters.innerHTML += `<br><strong>${i18next.t('widthInput')}:</strong> ${workflowData.width}`;
                parameters.innerHTML += `<br><strong>${i18next.t('heightInput')}:</strong> ${workflowData.height}`;
                ...
                parameters.innerHTML += `<br><strong>${i18next.t('helpS74')}:</strong> ${workflowData.scheduler}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS75')}:</strong> ${workflowData.cfg}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS713')}:</strong> ${workflowData.shift}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS77')}:</strong> ${workflowData.steps}`;
                parameters.innerHTML += `<br><strong>${i18next.t('widthInput')}:</strong> ${workflowData.width}`;
                parameters.innerHTML += `<br><strong>${i18next.t('heightInput')}:</strong> ${workflowData.height}`;
                ...
                parameters.innerHTML += `<br><strong>${i18next.t('helpS76')}:</strong> ${workflowData.guidance}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS77')}:</strong> ${workflowData.steps}`;
                parameters.innerHTML += `<br><strong>${i18next.t('helpS710')}:</strong> ${workflowData.feathering}`;

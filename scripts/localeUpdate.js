...
const promptModification = document.getElementById('promptModification');
const promptModificationP1 = document.getElementById('promptModificationP1');
const promptModificationP2 = document.getElementById('promptModificationP2');
const translationSystemPrompt = document.getElementById('translationSystemPrompt');
const refiningSystemPrompt = document.getElementById('refiningSystemPrompt');
...
export function updateLocale() {
    ...
    for (let i = 0; i < dlworkflow.length; i++) {
        dlworkflow[i].innerText = i18next.t('helpS3T6');
    }
    imageGenerationModels.innerText = i18next.t('helpS3');
    sd35desc.innerText = `${i18next.t('helpS3T1')}: fp8; ${i18next.t('helpS3T2')}: 8.1B; ${i18next.t('helpS3T3')}: 13.9 GB; ${i18next.t('helpS3T4')}: Stability AI; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T51')}`;
    sd35tdesc.innerText = `${i18next.t('helpS3T1')}: Q8 ${i18next.t('helpS3T2')}: 8.1B; ${i18next.t('helpS3T3')}: 8.8 GB; ${i18next.t('helpS3T4')}: Stability AI; ${i18next.t('helpS3T5')}; ${i18next.t('helpS3T51')}`;
    sdxldesc.innerText = `${i18next.t('helpS3T1')}: fp16; ${i18next.t('helpS3T2')}: 3.5B; ${i18next.t('helpS3T3')}: 6.5 GB; ${i18next.t('helpS3T4')}: Stability AI; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T52')}`;
    sdxltdesc.innerText = `${i18next.t('helpS3T1')}: fp16; ${i18next.t('helpS3T2')}: 3.5B; ${i18next.t('helpS3T3')}: 6.5 GB; ${i18next.t('helpS3T4')}: Stability AI; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T53')}`;
    flux1desc.innerText = `${i18next.t('helpS3T1')}: Q8; ${i18next.t('helpS3T2')}: 12B; ${i18next.t('helpS3T3')}: 11.8 GB; ${i18next.t('helpS3T4')}: Black Forest Labs; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T54')}`;
    fluxKreaDesc.innerText = `${i18next.t('helpS3T1')}: fp8; ${i18next.t('helpS3T2')}: 12B; ${i18next.t('helpS3T3')}: 11.1 GB; ${i18next.t('helpS3T4')}: Black Forest Labs; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T58')}`;
    hdi1fdesc.innerText = `${i18next.t('helpS3T1')}: fp8; ${i18next.t('helpS3T2')}: 17B; ${i18next.t('helpS3T3')}: 15.9 GB; ${i18next.t('helpS3T4')}: HiDream AI; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T55')}`;
    vv1bdesc.innerText = `${i18next.t('helpS3T1')}: fp8; ${i18next.t('helpS3T2')}: 12B; ${i18next.t('helpS3T3')}: 11.1 GB; ${i18next.t('helpS3T4')}: SG161222; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T56')}`;
    lumina2Desc.innerText = `${i18next.t('helpS3T1')}: bfp16; ${i18next.t('helpS3T2')}: 2.6B; ${i18next.t('helpS3T3')}: 9.9 GB; ${i18next.t('helpS3T4')}: Alpha-VLLM; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T57')}`;
    qwenImgDesc.innerText = `${i18next.t('helpS3T1')}: Q4_K_M; ${i18next.t('helpS3T2')}: 20B; ${i18next.t('helpS3T3')}: 12.1 GB; ${i18next.t('helpS3T4')}: Alibaba Cloud; ${i18next.t('helpS3T5')}: ${i18next.t('helpS3T58')}`;
    promptModification.innerText = i18next.t('helpS2');
    promptModificationP1.innerText = i18next.t('helpS2P1');
    promptModificationP2.innerText = i18next.t('helpS2P2');
    translationSystemPrompt.innerText = i18next.t('helpS2T1');
    refiningSystemPrompt.innerText = i18next.t('helpS2T2');
    fluxLoraModels.innerText = i18next.t('helpS4');
    for (let i = 0; i < sourceButton.length; i++) {
        sourceButton[i].innerText = i18next.t('helpS4T1');
    }
    editorModels.innerText = i18next.t('helpS5');
    colorizingHelp.innerText = i18next.t('helpS51');
    upscaling24help.innerText = i18next.t('helpS52');
    dlworkflow4.innerText = i18next.t('helpS52T1');
    dlworkflow2.innerText = i18next.t('helpS52T2');
    upscalingOtherHelp.innerText = i18next.t('helpS53');
    upscalingOtherDesc.innerText = i18next.t('helpS53Desc');
    outpaintingHelp.innerText = i18next.t('helpS54');
    outpaintingHelpDesc.innerText = i18next.t('helpS54Desc');
    supportModels.innerText = i18next.t('helpS6');
    sdxlRefinerDesc.innerHTML = i18next.t('helpS61P');
    juggernautXLDesc.innerHTML = i18next.t('helpS62P');
    terms.innerText = i18next.t('helpS7');
    ppTerm.innerHTML = `<strong>${i18next.t('helpS71')}:</strong> ${i18next.t('helpS71Desc')}`;
    npTerm.innerHTML = `<strong>${i18next.t('helpS72')}:</strong> ${i18next.t('helpS72Desc')}`;
    spTerm.innerHTML = `<strong>${i18next.t('helpS714')}:</strong> ${i18next.t('helpS714Desc')}`;
    saTerm.innerHTML = `<strong>${i18next.t('helpS73')}:</strong> ${i18next.t('helpS73Desc')}`;
    scTerm.innerHTML = `<strong>${i18next.t('helpS74')}:</strong> ${i18next.t('helpS74Desc')}`;
    cfTerm.innerHTML = `<strong>${i18next.t('helpS75')}:</strong> ${i18next.t('helpS75Desc')}`;
    guTerm.innerHTML = `<strong>${i18next.t('helpS76')}:</strong> ${i18next.t('helpS76Desc')}`;
    shTerm.innerHTML = `<strong>${i18next.t('helpS713')}:</strong> ${i18next.t('helpS713Desc')}`;
    stTerm.innerHTML = `<strong>${i18next.t('helpS77')}:</strong> ${i18next.t('helpS77Desc')}`;
    rsTerm.innerHTML = `<strong>${i18next.t('helpS78')}:</strong> ${i18next.t('helpS78Desc')}`;
    blTerm.innerHTML = `<strong>${i18next.t('helpS79')}:</strong> ${i18next.t('helpS79Desc')}`;
    feTerm.innerHTML = `<strong>${i18next.t('helpS710')}:</strong> ${i18next.t('helpS710Desc')}`;
    maTerm.innerHTML = `<strong>${i18next.t('helpS711')}:</strong> ${i18next.t('helpS711Desc')}`;
    loTerm.innerHTML = `<strong>${i18next.t('helpS712')}:</strong> ${i18next.t('helpS712Desc')}`;
    if (i18next.language == 'en') {

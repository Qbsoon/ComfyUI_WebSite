...
export async function galleryLoad(target, uid, current_page = null, limit_end = null, customManifestUrl = null, model = null, keywords = null, keywordsRadio = null) {
    ...
    if (isPagedGallery) {
        ...
        const models = ['sd_xl_base_1.0.safetensors', 'sd_xl_turbo_1.0_fp16.safetensors', 'sd3.5_large_fp8_scaled.safetensors', 'flux1-dev-Q8_0.gguf', 'hidream_i1_fast_fp8.safetensors', 'VerusVision_1.0b_Transformer_fp8.safetensors', 'lumina_2.safetensors', 'qwen-image-Q4_K_M.gguf', 'colorizing', 'upscaling', 'outpainting'];
        const modelNames = ['SDXL', 'SDXL Turbo', 'SD 3.5', 'FLUX1', 'HiDream I1 Fast', 'Verus Vision 1.0b', 'Lumina Image 2', 'Qwen Image', 'Colorizing', 'Upscaling', 'Outpainting'];
